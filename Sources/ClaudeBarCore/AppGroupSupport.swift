...
public enum AppGroupSupport {
    ...
    public static let teamIDInfoKey = "ClaudeBarTeamID"
    public static let legacyReleaseGroupID = "group.com.claudebar.app"
    public static let legacyDebugGroupID = "group.com.claudebar.app.debug"
    ...
    static func currentGroupID(teamID: String, bundleID: String?) -> String {
        let base = "\(teamID).com.claudebar.app"
        ...
        -> URL
    {
        ...
        let directory = base.appendingPathComponent("ClaudeBar", isDirectory: true)
