...
public enum ClaudeOAuthKeychainPromptPreference {
    static let releaseApplicationDefaultsDomain = "com.claudebar.app"
    static let debugApplicationDefaultsDomain = "com.claudebar.app.debug"
    ...
    /// Persist the Claude OAuth Keychain prompt policy used by ClaudeBar / CodexBar.
